function About() {
  return (
    <div>
      ...
      <p>Task or Treat combines the spirit of Halloween with the joy of giving. Please join us in spreading kindness and community spirit!</p>
      <p>&nbsp;</p>
      <h2>When to go Task or Treating</h2>
      <p>In short, whenever you want, and as often as you want! I'm reluctant to suggest any dates for this since any time is a good time and there's no reason to impose any restrictions on it.
        Personally I think a good time would be in the spring, when we're well past the holiday season and a more common time for giving. Another suggestion is today, because the best time to do something is when you're inspired to do it.</p>
      <h2>Other happiness resources:</h2>
      <ul>
        <li><a href="https://reasonstobecheerful.world/" target="_blank" rel="noopener noreferrer">Reasons to be Cheerful</a></li>
        <li><a href="https://www.drlauriesantos.com/happiness-lab-with-dr-laurie-santos-podcast" target="_blank" rel="noopener noreferrer">Happiness Lab with Dr. Laurie Santos</a></li>
      </ul>
	  <h2>Other ways to give:</h2>
      <ul>
        <li><a href="https://www.givingtuesday.org/" target="_blank" rel="noopener noreferrer">Giving Tuesday</a></li>
        <li><a href="http://givingmultiplier.org/" target="_blank" rel="noopener noreferrer">Giving Multiplier</a></li>
        <li><a href="https://www.givewell.org/" target="_blank" rel="noopener noreferrer">GiveWell</a></li>
      </ul>
    </div>
  );
}
